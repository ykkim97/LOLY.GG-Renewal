export default [
    {
        ...
        "data":{
            ...
            "SummonerTeleport":{
                "id":"SummonerTeleport",
                "name":"Teleport",
                "description":"After channeling for 4 seconds, teleports your champion to target allied structure, minion, or ward and grants a Movement Speed boost.",
                "tooltip":"After channeling for {{ f1 }} seconds, your champion teleports to target allied structure, minion, or ward and grants a {{ movespeedbuff }} Movement Speed boost for {{ msduration }} seconds.",
                "maxrank":1,
                "cooldown":[
                    360
                ],
